...
import '../../feature/counter/domain/repositories/counter_repository.dart'
    as _i5;
import '../../feature/counter/domain/usecases/get_counter_use_case.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.GetCounterUseCase>(() =>
        _i7.GetCounterUseCase(counterRepository: gh<_i5.CounterRepository>()));
    gh.lazySingleton<_i8.IncrementCounterUseCase>(() =>
        _i8.IncrementCounterUseCase(
